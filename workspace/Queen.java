...
//it's up to you how the piece moves, but at the very least the rules should 
//returns an arraylist of squares which are legal to move to
//please note that your piece must have some sort of logic. Just being able t
//going to score any points.
//My piece is the queen, it can move in any direction, in straight line
...
System.out.println("occupied");
if(b.getSquareArray()[posRow]
[posCol+i].getOccupyingPiece().getColor() != getColor()) {
...
for(int i = 1; posCol - i >= 0; i++){
if(b.getSquareArray()[posRow][posCol-i].isOccupied()) {
if(b.getSquareArray()[posRow][posCol-
i].getOccupyingPiece().getColor() == !getColor()) {
legalSquares.add(b.getSquareArray()[posRow][posCol-i]);
break;
} else {
break;
...
if(b.getSquareArray()[posRow+i]
[posCol].getOccupyingPiece().getColor() == !getColor()) {
...
for(int i = 1; (posRow + i <= 7)&&(posCol - i >= 0); i++){
if(b.getSquareArray()[posRow+i][posCol-i].isOccupied()) {
if(b.getSquareArray()[posRow+i][posCol-
i].getOccupyingPiece().getColor() == !getColor()) {
legalSquares.add(b.getSquareArray()[posRow+i][posCol-i]);
break;
} else {
