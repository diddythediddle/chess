...
// PostCondition: Returns ArrayList of Squares of where that piece can control,
...
moves.add(tSquare);
if (tSquare.getOccupyingPiece().getColor() !=
...
// PreCondition: Requires board and square instances of the whole board and of
